...
public class TestingOptional {
	 ...
	 * /
	 * https://tomgregory.com/java-optional/#:~:text=Java's%20Optional%20offers%20a%
	 * 20rich,if%20the%20Optional%20is%20empty
	 */
	public static void main(String[] args) {
		...
		// ------------------------------------
		// Optional in reality is a stream of size 1, so we can use all stream methods
		// like filter, map ..etc
