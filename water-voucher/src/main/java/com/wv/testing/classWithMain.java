...
public class classWithMain {
	...
	public static void main(String[] args) {
		...
		// Comparator<UserTest> compUser = (u1, u2) ->
		// u1.getAge().compareTo(u2.getAge());
		// *****************************SORTING start
		// **********************************************
		// ArrayList<UserTest> list = new ArrayList<>(); list.add(new UserTest(9L,78));
		// list.add(new UserTest(4L,55)); list.add(new UserTest(3L,44)); list.add(new
		// UserTest(2L,22));
		...
		//
		// Comparator<Double> compExample2 = (s, q) -> Objects.equals(q, s)?1:2;//we
		// should return int because this is the return type of compare() the single
		// method in the interface
		//
		// System.out.println(compExample2.compare(1176.2, 228.0)); //compExample2
		// accepts only Double
		//
		// Comparator<Double> compTheOldWay = new Comparator<Double>() {
		// //before java 8 there was inline implementation for interfaces, not only
		// functional interfaces ut even the one which have more than one interface like
		// List
		//
		// @Override
		 ...
		 * https://www.geeksforgeeks.org/difference-between-callable-and-runnable-in-
		 * java/
		 */

		// System.out.println(compTheOldWay.compare(1176.2, 228.0)); //compTheOldWay
		// accepts only Double
