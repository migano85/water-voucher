...
public class TestingMapAndFlatMap {
        /*************************************
         * 7777777 LAZY EVALUATION of streams is very important topic, read this
         * article: https://stackify.com/streams-guide-java-8/
         *************************************
         */
        ...
        public static void main(String[] args) {
                ...
                List<Integer> flatList = number.stream()
                                ...
                                // .flatMap(lst -> lst.stream()) //convert all List<Integer> to streams than
                                // merge them on one stream using flatMap
                                // .toList();
